...
class Patient(BaseModel):
    ...
    city: Annotated[str, Field(..., description='Enter city where u living')]
...
def view_patient(patient_id: str = Path(..., desc='Patient ID in the form of a string',example='P001')):
    data = load_data()
...
def create_patient(patient: Patient):
    ...
    return JSONResponse(status_code=201, content={'message':'New patient is added'})
